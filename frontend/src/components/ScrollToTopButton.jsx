...
const isAcheterPage =
  location.pathname.startsWith("/acheter/numero") ||
  ...
  return (
    <button
      ...
      style={{
        ...
        height: "50px",
        borderRadius: "50%",
        backgroundColor: isAcheterPage ? "#120573" : "#ff5430",
        color: "white",
        border: "none",
        fontSize: "27px",
        cursor: "pointer",
